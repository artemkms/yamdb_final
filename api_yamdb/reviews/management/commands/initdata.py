...
def get_model(model_name):
    ...
    По имени из командной строки, либо из настроечной константы
    tuple: ordered_load_models
    """
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        """Настраивает аргументы принимаемые из командной строки."""
        parser.add_argument('--models', nargs='+', type=str, default='--all')

    def handle(self, *args, **options):
        """Обработка аргументов командной строки и загрузка данных."""
